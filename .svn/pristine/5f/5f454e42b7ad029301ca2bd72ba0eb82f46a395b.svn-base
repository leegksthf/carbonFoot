											...
											if(results2.length > 0){
												...
												for(var i = 0; i < results2.length; i++){
													...
													if(results2[i].type == "android"){
														...
														androidPush.push("free", results2[i].key_num, connectorName, brd_title, connectorNo, brd_no[0].brd_no, "", results2[i].popup_yn);
													} else if(results2[i].type == "ios"){
														console.log("results2[i].type == " + results2[i].type + " >> IOS");
														ios_push_url = "/board_view?brd_no=" + brd_no[0].brd_no;
														iosPush.push("free", results2[i].key_num, connectorName, brd_title, connectorNo, brd_no[0].brd_no, "", results2[i].popup_yn);
													} else {
