...
exports.listener=function(request, response){
	...
	if(eventData.status == "C"){
		...
		"(title, start, end, backgroundColor, textColor, allDay, description) " +
		"values ('" + eventData.title + "', '" + eventData.start + "', '" + eventData.end + "', '" + eventData.backgroundColor + "', '" + eventData.textColor + "', '" + eventData.allDay + "' , '" + eventData.description + "')";
