...
exports.listener=function(request, response){
	...
	var board_no = "";
	var brd_create_date = "";
	var hongbo_type =  request.param("hongbo_type") == undefined ? "" : request.param("hongbo_type");
	...
	if(mode=="write"){
		sql = "insert into "+table+"(" +
				"board_id, board_title, board_content, sort,orgmem_no, hongbo_type, " +
