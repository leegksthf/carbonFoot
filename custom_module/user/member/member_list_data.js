...
exports.listener=function(request, response){
	...
	var num_type = request.param("num_type")==undefined ? "num1" : request.param("num_type");
	...
	switch(num_type){
		...
		case "num1":
			count_where_sql += "AND orgmem_branch = '104' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num2":
			count_where_sql += "AND orgmem_branch = '110' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num3":
			count_where_sql += "AND orgmem_branch = '115' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num4":
			count_where_sql += "AND orgmem_branch = '120' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num5":
			count_where_sql += "AND orgmem_branch = '125' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num6":
			count_where_sql += "AND orgmem_branch = '130' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
	...
	switch(num_type){
		...
		case "num1":
			where_sql += "AND orgmem_branch = '104' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num2":
			where_sql += "AND orgmem_branch = '110' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num3":
			where_sql += "AND orgmem_branch = '115' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num4":
			where_sql += "AND orgmem_branch = '120' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num5":
			where_sql += "AND orgmem_branch = '125' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
		case "num6":
			where_sql += "AND orgmem_branch = '130' AND (orgmem_branch != '099' OR orgmem_branch IS null)\n";
		break;
	...
	//정렬
	if(num_type != 'num4'){
		sql += "order by orgmem_committee_position IS NULL asc, orgmem_committee_position*10 asc, orgmem_sub_position*10\n";	
	}else{
		sql += "order by orgmem_sub_position IS NULL asc, orgmem_sub_position*10 asc \n";
	}
